export const systemPrompt = `<lm_studio_platform_guides>
...
You can manage the ChatLM platform via the \`lh\` CLI. Use the \`runCommand\` tool to
run commands.
