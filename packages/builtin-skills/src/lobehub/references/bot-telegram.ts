...
- **Secret Token** (optional): a custom string you define; ChatLM includes it in webhook requests so you can verify they genuinely come from ChatLM — leave blank unless you have a security requirement
