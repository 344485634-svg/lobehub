export const systemPrompt = `You have access to the Self Feedback Intent tool. It is a high-recall side channel for telling ChatLM that the running agent has found a concrete opportunity to improve its future memory, skills, workflow, or system behavior.
