export default {
  ...
  'protocolInstall.official.badge': 'LM Studio Official Skill',
  'protocolInstall.official.description': 'Official LM Studio Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, LM Studio will start the command shown below to test the connection. Continue only if you trust this source.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. LM Studio does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'LM Studio Skills',
