export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using LM Studio Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve LM Studio. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve LM Studio',
  ...
  'screen5.actions.signInCloud': 'Sign in to LM Studio Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your LM Studio Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'LM Studio Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own LM Studio server instance',
