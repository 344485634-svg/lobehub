export default {
  ...
  'authResult.success.desc': 'Please click the Start button below to continue using ChatLM Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve ChatLM. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve ChatLM',
  ...
  'screen5.actions.signInCloud': 'Sign in to ChatLM Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your ChatLM Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'ChatLM Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own ChatLM server instance',
