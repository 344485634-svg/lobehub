export default {
  ...
  'ModelSwitchPanel.emptyModel': 'No enabled model. Please contact the administrator.',
  'ModelSwitchPanel.emptyProvider': 'No enabled providers. Please contact the administrator.',
  'ModelSwitchPanel.goToSettings': 'Contact administrator',
  'ModelSwitchPanel.manageProvider': 'Models are managed by administrators',
