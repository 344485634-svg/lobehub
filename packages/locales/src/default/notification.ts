export default {
  ...
  'email.footer.preference':
    'You received this email because of your notification settings on LM Studio.',
  'email.footer.system': 'This is an important account notification from LM Studio.',
