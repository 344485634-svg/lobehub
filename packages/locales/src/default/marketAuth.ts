export default {
  ...
  'authorize.description': 'Your {{appName}} account is all you need to use this feature.',
  ...
  'authorize.scenes.connector.confirm': 'Continue',
  'authorize.scenes.connector.description':
    'This authorization is handled through your {{appName}} account.',
  'authorize.scenes.connector.subtitle': 'Sign in to authorize this service.',
  'authorize.scenes.connector.title': 'Authorize Service',
  'authorize.scenes.mcp.subtitle': 'Authorize to install and run this skill.',
  'authorize.scenes.mcp.title': 'Authorize Skill',
  'authorize.scenes.sandbox.subtitle': 'Authorize to run this tool.',
  'authorize.scenes.sandbox.title': 'Authorize Tool',
  'authorize.subtitle': 'Authorize to use this feature.',
  'authorize.title': 'Authorize',
  'callback.buttons.close': 'Close Window',
  'claimResources.claim': 'Claim Selected',
  'claimResources.description': 'Your account has resources available to claim:',
  ...
  'callback.titles.loading': 'ChatLM Authorization',
  ...
  'messages.authorized': 'ChatLM service authorized successfully',
  ...
  'profileSetup.descriptionEdit': 'Update your profile information.',
  'profileSetup.descriptionFirstTime': 'Set up your profile to get started.',
