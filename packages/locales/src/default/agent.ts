export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to ChatLM. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with ChatLM on Slack, Discord, Telegram.',
  ...
  'channel.imessage.description':
    'Connect this agent to iMessage through the local ChatLM Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in ChatLM Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and ChatLM Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, ChatLM Desktop receives local BlueBubbles webhooks and forwards them to ChatLM.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to ChatLM. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to ChatLM. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to ChatLM, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The ChatLM Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between ChatLM Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
