export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote LM Studio server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'LM Studio Cloud',
