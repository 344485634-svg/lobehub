export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote ChatLM server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'ChatLM Cloud',
