export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by ChatLM Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'ChatLM could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'ChatLM could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through ChatLM's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'ChatLM optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to ChatLM',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not ChatLM's, and ChatLM takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'ChatLM will run this task when no assignee is set',
