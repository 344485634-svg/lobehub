export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by LM Studio Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'LM Studio could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'LM Studio could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through LM Studio's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'LM Studio optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to LM Studio',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not LM Studio's, and LM Studio takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'LM Studio will run this task when no assignee is set',
