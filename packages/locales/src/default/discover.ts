export default {
  ...
  'createGuide.func1.title': 'Submit in ChatLM',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the ChatLM Community.',
  'footer.title': 'Share your creation on ChatLM Community today',
  ...
  'models.providerInfo.apiTooltip': 'ChatLM supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'ChatLM Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by ChatLM automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the ChatLM marketplace with one click.',
