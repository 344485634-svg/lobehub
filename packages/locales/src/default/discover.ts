export default {
  ...
  'createGuide.func1.title': 'Submit in LM Studio',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the LM Studio Community.',
  'footer.title': 'Share your creation on LM Studio Community today',
  ...
  'models.providerInfo.apiTooltip': 'LM Studio supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'LM Studio Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by LM Studio automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the LM Studio marketplace with one click.',
