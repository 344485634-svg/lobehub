  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: #ffffff; border-radius: 20px; padding: 40px; box-shadow: 0 8px 30px rgba(0,0,0,0.04); border: 1px solid rgba(0,0,0,0.02);">
      ...
      <div style="color: #374151; font-size: 16px; line-height: 1.6;">
        ...
        <p style="margin: 0 0 24px 0;">
          We received a request to change your ChatLM account email to this address. Please confirm by clicking the button below.
        </p>
    ...
    <div style="text-align: center; margin-top: 32px;">
      <p style="color: #a1a1aa; font-size: 13px; margin: 0;">
        © 2026 ChatLM. All rights reserved.
      </p>
    </div>
  </div>
</body>
    ...
    `,
    subject: 'Confirm Your New Email - ChatLM',
    text: `You requested to change your ChatLM account email. Please confirm by clicking this link: ${url}\n\nThis link will expire in ${expirationText}.\n\nIf you didn't request this change, you can safely ignore this email.`,
  };
};
